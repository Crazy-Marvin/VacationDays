...
class VacationDaysInfoWithWorkProvider : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
            WidgetTheme {
                ...
                val remainingVacationDays = viewModel.remainingVacationDays.collectAsState()
                val workDays = viewModel.workDays.collectAsState()
                Column(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Text(
                                context.getString(R.string.vacation_days_available),
                                style = TextStyle(
                                    color = GlanceTheme.colors.onSecondary,
                                    fontSize = 15.sp,
                                ),
                            ...
                            Text(
                                remainingVacationDays.value?.toString() ?: "0", style = TextStyle(
                                    color = GlanceTheme.colors.onBackground,
                                    fontSize = 35.sp,
                                    fontWeight = FontWeight.Bold
                                ),
                        ...
                        Row(
                            ...
                            Text(
                                workDays.value?.toString() ?: "0", style = TextStyle(
                                    color = GlanceTheme.colors.onBackground,
                                    fontSize = 35.sp,
                                    fontWeight = FontWeight.Bold
                                ),
