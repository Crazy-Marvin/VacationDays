...
import rocks.poopjournal.vacationdays.presentation.ui.utils.SQLITE_SHMFILE_SUFFIX
import rocks.poopjournal.vacationdays.presentation.ui.utils.SQLITE_WALFILE_SUFFIX
import rocks.poopjournal.vacationdays.presentation.ui.utils.THEDATABASE_DATABASE_BACKUP_SUFFIX
...
class DatabaseBackupManager @Inject constructor(
    ...
    fun restoreDatabase(restart: Boolean = true) {
        ...
        if (vacationDatabase == null) return
        val dbPath = vacationDatabase.openHelper.readableDatabase.path
    ...
    private fun checkpoint() {
        val db = vacationDatabase.openHelper.writableDatabase
